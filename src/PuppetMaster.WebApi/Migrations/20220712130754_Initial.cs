    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UniqueGameId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameUsers_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LobbyLeaderId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LobbyId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MapVote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchTeamUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MatchTeamUsers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MatchTeamUsers_MatchTeams_MatchTeamId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameUsers_ApplicationUserId",
                table: "GameUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchTeamUsers_ApplicationUserId",
                table: "MatchTeamUsers",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchTeamUsers_MatchTeamId",
                table: "MatchTeamUsers",
                column: "MatchTeamId");
